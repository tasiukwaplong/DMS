...
if (isset($_GET['s']) && !empty($_GET['s'])) {
  ...
  $msgCode = 3;
    ...
    $sheetName = '';
  $msgCode = 0;
  $msgbody = 'Sheet name not selected. Click <a data-toggle="modal" href="#myModal">here to select or create sheet</a>';
}
?>
<!DOCTYPE html>
<!-- saved from url=(0054)# -->
...
<head>
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="../profile/"><span class="glyphicon glyphicon-edit"></span> Settings</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="../create/">Create Debt Sheet</a></li>
          ...
          <div class="nav navbar-nav navbar-right">
            <div class="well well-sm">
              ...
              for($j=0; $j<$debt_sheets; $j++){
                ...
                "<tbody>
                <tr><td>
                <a href='../manage/?s=$sheetName'><span class='glyphicon glyphicon-pencil'></span></a>
                    $sheet_details[debt_id]</td>\n
                ...
                No sheet with name:". @test_input($_GET['s'])." <br>
                It will be created when the add button is clicked
                </div
                </td>
                </tr>
                </tbody>
    ...
    <div class="input-group col-xs-4">
      ...
      <textarea id="names" class="form-control" name="addInfo" placeholder="Additional Info" required=""></textarea>
    </div>

    <div class="input-group col-xs-4" style="margin-left: 50px">
      <br>
      <?php if($msgCode == 0){?>
    ...
    <strong>Error: </strong> Cannot add to sheet: <?php echo $msgbody;?><br>
  </div>
  ...
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Create sheet</button>
